...
# steps to create datasets: https://github.com/lindawangg/COVID-Net/blob/master/docs/COVIDx.md
# set parameters here
savepath = 'data'
seed = 0
...
sirm_imgpath = 'data/COVID'
sirm_csvpath = 'data/COVID/COVID.metadata.xlsx'
...
for key in patients.keys():
    ...
    # num_test = max(1, round(split*num_diff_patients))
    test_patients = np.load('data/rsna-pneumonia-detection-challenge/rsna_test_patients_{}.npy'.format(key)) # random.sample(list(arr), num_test), download the .npy files from the repo.
